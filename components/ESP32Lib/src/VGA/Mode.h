...
class Mode
{
  public:
	...
	void print(Mode &output) const
	{
		printf("hFront: %d\nhSync: %d\nhBack: %d\nhRes: %d\n", output.hFront, output.hSync, output.hBack, output.hRes);
		printf("vFront: %d\nvSync: %d\nvBack: %d\nvRes: %d\nvDiv: %d\n", output.vFront, output.vSync, output.vBack, output.vRes, output.vDiv);
		printf("pixelClock: %lu\nhSyncPolarity: %d\nvSyncPolarity: %d\n", output.pixelClock, output.hSyncPolarity, output.vSyncPolarity);
		/*output.print("hFront: ");
